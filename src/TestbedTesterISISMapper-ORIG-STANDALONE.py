...
def createGraph():
  ...
  G.graph_attr['label']='AcmeAutomator Lab ' + time.strftime("%d/%m/%Y") + ' @ ' + time.strftime("%H:%M:%S")
...
if __name__ == '__main__':
  ...
  G.string()
  G.write("AcmeAutomator-ISIS-Map.dot")
  print("Wrote DOT language output file: AcmeAutomator-ISIS-Map.dot")
  print("Wrote final diagram output file: AcmeAutomator-ISIS-Map.png")
  G.draw("AcmeAutomator-ISIS-Map.png",prog='dot',args='-Tpng')
